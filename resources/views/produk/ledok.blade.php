...
<div x-data="{ open: false }" class="w-full">
    ...
    <div class="hidden md:flex w-full min-h-screen relative overflow-hidden bg-cover bg-center bg-no-repeat items-center justify-start py-4 px-8 lg:px-12" 
         style="background-image: url('{{ asset('image/ledokproduk.gif') }}');">
        ...
        <div class="w-full relative z-10 flex flex-row items-center justify-start md:-space-x-20 text-white -mt-24">
            ...
            <div class="w-auto flex-shrink-0 relative z-20">
                <img src="{{ asset('image/foto-ledok-ledok.png') }}" alt="Produk" class="w-full max-w-[440px] drop-shadow-2xl object-contain">
            </div>

            <!-- Deskripsi Hero Laptop -->
            <div class="max-w-[480px] text-left flex flex-col items-start relative z-10 pl-2">
                <h1 class="text-5xl font-black mb-3 text-[#A3E635] drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] tracking-wide">
                    Ledok-Ledok
                </h1>
                <p class="text-xl leading-relaxed mb-6 font-bold text-black w-full drop-shadow-[0_1px_2px_rgba(255,255,255,0.5)]">
                    varian ledok-ledok terbuat dari labu <br class="hidden sm:inline"> kuning, sorgum, bayam serta telur <br class="hidden sm:inline">yang kaya akan vitamin A <br> serta Zat besi
                </p>
                <!-- Tombol Beli Laptop -->
    ...
    <!-- ========================================== -->
    <div class="flex md:hidden w-full min-h-screen relative overflow-hidden bg-[length:100%_100%] bg-center bg-no-repeat flex flex-col justify-start pt-6 pb-6 px-6 text-white" 
         style="background-image: url('{{ asset('image/gumi bali.gif') }}');">
        
        <!-- Atas: Judul (Diturunkan sedikit) -->
        <div class="w-full text-center mb-1 mt-2 relative z-10">
        ...
        <div class="w-full flex justify-center mb-2 relative z-10">
            <p class="text-[11px] font-bold text-black leading-snug text-center max-w-[220px] drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)]">
                varian ledok-ledok terbuat dari labu kuning, sorgum, bayam serta telur yang kaya akan vitamin A serta Zat besi
            </p>
        </div>

        <!-- Tengah: Foto Produk (Dinaikkan sedikit) -->
        <div class="w-full flex items-center justify-center my-0 -mt-5 relative z-10">
            <img src="{{ asset('image/foto-ledok-ledok.png') }}" alt="Produk" class="w-44 drop-shadow-2xl object-contain">
        </div>
    ...
    <div x-show="open" 
        ...
        <div @click.away="open = false" 
            ...
            <div class="flex flex-col items-center text-center p-2 mb-3">
                <img src="{{ asset('image/foto-ledok-ledok.png') }}" alt="Produk Ledok-Ledok" class="w-44 sm:w-56 object-contain drop-shadow-2xl">
                <h3 class="text-3xl md:text-4xl font-black text-[#15803d] mt-3 tracking-wide">Ledok-Ledok</h3>
            </div>
                ...
                <div class="bg-white p-3 rounded-2xl flex items-center justify-between shadow-[0_4px_12px_rgba(0,0,0,0.03)] border border-gray-100/50 hover:border-orange-200 transition-colors gap-2">
                    <div class="flex items-center gap-2.5 min-w-0">
                        ...
                        <div class="truncate">
                            ...
                            <span class="text-[10px] font-medium text-gray-400 block truncate mt-1">Ledok-Ledok Official Store</span>
                        </div>
                    </div>
...
<!-- ========================================================= -->
<!-- SECTION 2: TAMPILAN KHUSUS HP (MENGGUNAKAN BG GUMI4.PNG)   -->
<!-- ========================================================= -->
<div class="flex md:hidden w-full min-h-screen relative overflow-hidden bg-[length:100%_100%] bg-center bg-no-repeat flex flex-col items-center justify-between pb-6 pt-24 px-6 gap-5" 
     style="background-image: url('{{ asset('image/gumi4.png') }}');">
    
    <!-- Judul & Deskripsi Atas (Diturunkan lagi dengan menambahkan mt-8) -->
    <div class="w-full text-center relative z-10 px-2 flex flex-col gap-1.5 mt-8">
    ...
    <!-- Bagian Kartu Accordion Keunggulan (Diturunkan lagi mendekati bawah dengan memperkecil mb-6 agar tidak terdorong ke atas) -->
    <div class="w-full relative z-10 flex flex-col gap-2 text-left max-w-[330px] mb-6">
