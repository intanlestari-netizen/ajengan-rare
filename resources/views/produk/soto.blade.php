...
<div x-data="{ open: false }" class="w-full">
    ...
    <div class="hidden md:flex w-full min-h-screen relative overflow-hidden bg-cover bg-center bg-no-repeat items-center justify-start py-4 px-8 lg:px-12" 
         style="background-image: url('{{ asset('image/sotoproduk.gif') }}');">
        ...
        <div class="w-full relative z-10 flex flex-row items-center justify-start md:-space-x-20 text-white -mt-24">
            ...
            <div class="w-auto flex-shrink-0 relative z-20">
                <img src="{{ asset('image/foto-soto.png') }}" alt="Produk" class="w-full max-w-[440px] drop-shadow-2xl object-contain">
            </div>
            ...
            <div class="max-w-[480px] text-left flex flex-col items-start relative z-10 pl-2">
                ...
                <p class="text-xl leading-relaxed mb-6 font-bold text-black w-full drop-shadow-[0_1px_2px_rgba(255,255,255,0.5)]">
                    varian soto terbuat dari labu siam, <br class="hidden sm:inline">ayam kampung serta rempah alami <br class="hidden sm:inline">yang tinggi protein dan antioksidan
                </p>
                <!-- Tombol Beli Laptop -->
    ...
    <!-- ========================================== -->
    <div class="flex md:hidden w-full min-h-screen relative overflow-hidden bg-[length:100%_100%] bg-center bg-no-repeat flex-col justify-start pt-4 pb-6 px-6 text-white" 
        ...
        <div class="w-full flex justify-center mb-2 relative z-10">
            <p class="text-[11px] font-bold text-black leading-snug text-center max-w-[220px] drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)]">
                varian soto terbuat dari labu siam, ayam kampung serta rempah alami yang tinggi protein dan antioksidan
            </p>
        </div>

        <!-- Tengah: Foto Produk -->
        <div class="w-full flex items-center justify-center my-0 -mt-2 relative z-10">
            <img src="{{ asset('image/foto-soto.png') }}" alt="Produk" class="w-44 drop-shadow-2xl object-contain">
        </div>
    ...
    <div x-show="open" 
        ...
        <div @click.away="open = false" 
            ...
            <div class="flex flex-col items-center text-center p-2 mb-3">
                <img src="{{ asset('image/foto-soto.png') }}" alt="Produk Soto Kids" class="w-44 sm:w-56 object-contain drop-shadow-2xl">
                <h3 class="text-3xl md:text-4xl font-black text-[#15803d] mt-3 tracking-wide">Soto Kids</h3>
            </div>
                ...
                <div class="bg-white p-3 rounded-2xl flex items-center justify-between shadow-[0_4px_12px_rgba(0,0,0,0.03)] border border-gray-100/50 hover:border-orange-200 transition-colors gap-2">
                    <div class="flex items-center gap-2.5 min-w-0">
                        ...
                        <div class="truncate">
                            ...
                            <span class="text-[10px] font-medium text-gray-400 block truncate mt-1">Soto Kids Official Store</span>
                        </div>
                    </div>
...
<div class="flex md:hidden w-full min-h-screen relative overflow-hidden bg-[length:100%_100%] bg-center bg-no-repeat flex flex-col items-center justify-end pb-8 pt-4 px-5 gap-4" 
     style="background-image: url('{{ asset('image/gumi4.png') }}');">
    
    <div class="w-full text-center relative z-10 px-2 flex flex-col gap-1">
        <h2 class="text-xl font-black text-[#15803d] tracking-wide drop-shadow-md leading-tight">
           Ajengan Rare Hadir Sebagai Solusi
        </h2>
        <p class="text-[10px] font-semibold text-gray-700 max-w-[260px] mx-auto leading-relaxed opacity-90">
          Ajengan Rare, solusi MPASI sehat berbasis kearifan lokal Bali yang praktis, ready-to-sip, dan kaya nutrisi untuk mendukung tumbuh kembang optimal bayi
        </p>
    </div>
    
    <div class="w-full relative z-10 flex flex-col gap-1.5 text-left max-w-[320px]">
        
        <details class="w-full bg-white rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.03)] border border-gray-100 transition-all duration-300 group">
            <summary class="flex items-center justify-between w-full p-2 cursor-pointer list-none focus:outline-none">
            ...
            <div class="px-2 pb-2.5 pt-0.5 text-[10px] text-gray-600 leading-normal border-t border-gray-50 mt-1">
                Dibuat murni dari bahan alami pilihan tanpa tambahan pengawet kimia maupun gula buatan, sehingga sangat aman untuk pencernaan sensitif Si Kecil.
            </div>
        </details>
