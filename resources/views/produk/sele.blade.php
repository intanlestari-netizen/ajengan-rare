...
<div class="max-w-[1200px] mx-auto min-h-screen flex items-center px-8">
    <div class="flex flex-col md:flex-row items-center gap-12 bg-black/20 backdrop-blur-sm p-10 rounded-3xl">
        <div class="w-full md:w-5/12">
            ...
            <img src="{{ asset('image/sele.png') }}" alt="Sele Bun" class="w-full drop-shadow-2xl">
        </div>
        <div class="w-full md:w-7/12 text-white">
            <p class="mb-4 text-lg">Home > <span class="font-bold">Sele Bun</span></p>
            <h1 class="text-6xl font-black mb-6">Sele Bun</h1>
            <p class="text-xl leading-relaxed mb-8">
                Camilan sehat berbahan dasar ubi lokal yang diolah secara higienis untuk menjaga nutrisi alami.
            </p>
